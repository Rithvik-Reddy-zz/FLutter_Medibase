...
// ------------------------------------------------------------------------------------------
    ...
    Container makeListTile(Prescription prescription) => Container(
      ...
      child: Column(
        ...
        children: <Widget>[Row(
          ...
          Tile_elements(title: prescription.name,value: prescription.type,)],
        ),
        Divider(
          indent: 20,
          endIndent: 20,
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Tile_elements(title:  "Pills per day",value: prescription.dosage,)
            ],
          )
        ],
      ),
    ...
    final makeBody = Container(
            child: ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: lesson.list_of_prescriptions.length,
              itemBuilder: (BuildContext context, int index) {
                return makeCard(lesson.list_of_prescriptions[index]);
              },
            ),
